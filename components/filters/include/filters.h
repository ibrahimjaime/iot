...
void MovingAvaregeInit(struct MovAvrS *MovAvrData,int len); //Function to initialize and also reset the filter. It gives the filter the length of the window array

void MovingAvarageFilter(struct MovAvrS *MovAvrData,float *windowArray,float newData); //It modifies the MovAvrResult, result of the filter
